...
kinolar = {
    'ali' : ['Terminator', 'Forsaj', 'Titanik'],
    'vali' : ['Dunyo', 'Snayper', 'Rembo'],
    'hasan' : ['Jhon Wick', 'Bomba', 'Tenet']
    }

for name, movies in kinolar.items():
    print(f"{name.title()}ning sevimli kinolari:")
    for kino in movies:
        print(kino)
